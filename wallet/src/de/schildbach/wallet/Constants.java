...
public final class Constants {
    ...
    public static final boolean TEST = BuildConfig.APPLICATION_ID.contains("test");
    ...
    public static final String getBlockExplorer(){
        if(TEST){
            return EXPLORE_BASE_URL_TEST;
        }else {
            return EXPLORE_BASE_URL_PROD;
        }
    }
    ...
    private static final String EXPLORE_BASE_URL_PROD = CoinDefinition.BLOCKEXPLORER_BASE_URL;
    private static final String EXPLORE_BASE_URL_TEST = CoinDefinition.TEST_BLOCKEXPLORER_BASE_URL;
    ...
    public static MonetaryFormat getAssetFormat(int decimals) {
        return new MonetaryFormat().noCode().minDecimals(decimals).optionalDecimals().roundingMode(RoundingMode.FLOOR);
    }
    ...
    public static final int NOTIFICATION_START_ID_COINS_RECEIVED = 100;

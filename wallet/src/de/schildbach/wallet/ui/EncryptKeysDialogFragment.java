...
public class EncryptKeysDialogFragment extends DialogFragment {
    ...
    //是否需要显示旧密码输入框,这里在启动dialog时该值就要确定，且不可更改。
    private boolean needShowOldEdt = true;
    ...
    public void onAttach(final Activity activity) {
        ...
        needShowOldEdt = wallet.isEncrypted();
    }
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        builder.setTitle(needShowOldEdt ? R.string.encrypt_keys_reset_dialog_title:R.string.encrypt_keys_setting_dialog_title);
    ...
    private void updateView() {
        ...
        oldPasswordGroup.setVisibility(needShowOldEdt ? View.VISIBLE : View.GONE);
        ...
        if (state == State.INPUT) {
            if (wallet.isEncrypted()) {
                positiveButton.setText(hasPassword ? R.string.button_ok : R.string.button_remove);

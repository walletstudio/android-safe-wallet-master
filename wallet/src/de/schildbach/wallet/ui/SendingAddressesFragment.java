...
public final class SendingAddressesFragment extends FancyListFragment
    ...
    private void handleSend(final String address, String label) {
    ...
    private void handleShowQr(final String address, final String label) {
        final String uri = BitcoinURI.convertToBitcoinURI2(Constants.NETWORK_PARAMETERS, address, null, label, null, null);

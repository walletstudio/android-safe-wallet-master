...
public class StoredBlock {
    ...
    public boolean moreWorkThan(StoredBlock other) {
        if (height >= Constants.NETWORK_PARAMETERS.getStartSposHeight()) {
            return activeTime.compareTo(other.activeTime) > 0;
        } else {
    ...
    public boolean equals(Object o) {
        ...
        if (height >= Constants.NETWORK_PARAMETERS.getStartSposHeight()) {
            return header.equals(other.header) && activeTime.equals(other.activeTime) && height == other.height;
        } else {
    ...
    public int hashCode() {
        if (height >= Constants.NETWORK_PARAMETERS.getStartSposHeight()) {
            return Objects.hashCode(header, activeTime, height);
        } else {
    ...
    public StoredBlock build(Block block) throws VerificationException {
        ...
        if (height >= Constants.NETWORK_PARAMETERS.getStartSposHeight()) {
            BigInteger chainWork = this.activeTime.add(new BigInteger(String.valueOf(block.getNonce())));

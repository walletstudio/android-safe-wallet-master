...
//    //测试链相关配置
//    public static final int TEST_PORT = 4488;       //测试端口
//    public static final long TEST_PACKET_MAGIC = 0x646468c8;  //测试魔数
//    public static final int TEST_TARGET_SPACING = (int) (2.5 * 60);  // 2.5分钟产生一个块
//    public static final int TEST_SAFE_BRANCH_HEIGHT = 175; //测试分叉高度
//    public static final int TEST_DASH_DISABLE_HEIGHT = 400; //测试达世封存高度
//    public static final int TEST_START_SPOS_HEIGHT = 2647; // 开始SPOS高度

...
public abstract class NetworkParameters {
    ...
    public static final long MAX_ASSET_COINS = CoinDefinition.MAX_ASSET_COINS;

    public static final Coin MAX_MONEY = COIN.multiply(MAX_COINS);

    public static final Coin MAX_ASSET_MONEY = Coin.valueOf(MAX_ASSET_COINS);
    ...
    public int getCriticalHeight() {
        return nCriticalHeight;
    }

    public int getStartSposHeight() {
    ...
    public Coin getMaxAssetCoin(){
        return Coin.valueOf(MAX_ASSET_COINS);
    }
}
